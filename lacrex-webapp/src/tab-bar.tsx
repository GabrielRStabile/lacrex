...
import { File, useNavigationSystem } from './contexts/navigation-system-context'
...
function TabBar() {
  ...
  return (
    <div className="bg-[#3F3F46] shadow-md rounded-[10px] p-4 border-[1px] border-[#71717A] h-fit flex gap-3 justify-between">
      <ul className="flex space-x-2">
        ...
        {!recentlyOpenedFiles.length && <div className="py-5"></div>}
      </ul>
