...
export class LaCreXLexer extends Lexer {
	...
	public static readonly ruleNames: string[] = [
		"WhiteSpace", "COMMA", "PONTOEVIRGULA", "LPAREN", "RPAREN", "LCURLY", 
		"RCURLY", "SE", "SENAO", "FOREACH", "WHILE", "BOOLEANO", "NOMEVARIAVEL", 
		"LETRA", "DIGITO", "DECREMENTOOUINCREMENTO", "TIPOS", "TIPAGEM", "NULAVEL", 
		"OPERADORATRIBUICAO", "OPERADORCONDICIONAL",
	];

	private static readonly _LITERAL_NAMES: Array<string | undefined> = [
		undefined, undefined, "','", "';'", "'('", "')'", "'{'", "'}'", "'elu'", 
		"'delu'", "'segue o fio'", "'comofas'", undefined, undefined, undefined, 
		undefined, undefined, undefined, undefined, "'cancelado'", "'\uD83D\uDC8B'",
	];
	private static readonly _SYMBOLIC_NAMES: Array<string | undefined> = [
		undefined, "WhiteSpace", "COMMA", "PONTOEVIRGULA", "LPAREN", "RPAREN", 
		"LCURLY", "RCURLY", "SE", "SENAO", "FOREACH", "WHILE", "BOOLEANO", "NOMEVARIAVEL", 
		"LETRA", "DIGITO", "DECREMENTOOUINCREMENTO", "TIPOS", "TIPAGEM", "NULAVEL", 
		"OPERADORATRIBUICAO", "OPERADORCONDICIONAL",
	];
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(LaCreXLexer._LITERAL_NAMES, LaCreXLexer._SYMBOLIC_NAMES, []);
	...
	// @Override
	public get serializedATN(): string { return LaCreXLexer._serializedATN; }
	...
	public static get _ATN(): ATN {
		if (!LaCreXLexer.__ATN) {
			LaCreXLexer.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(LaCreXLexer._serializedATN));
		}
